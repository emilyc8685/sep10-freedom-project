# Entry 4 : Freedom Project Tool
##### 3/9/26

### Content
  The tool I chose for my freedom project was Sass. I chose Sass because it gives CSS features it doesn't have that makes using CSS easier. I tinkered with Sass by setting variables to change my h1. Sass uses the $ symbol to set variables which I used to change the font size and color of my h1. 
